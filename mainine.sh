...
function help {
  ...
  echo "Don't forget to give permission to execute this file (chmod +x mainine.sh)."
  echo ""
...
../insane -u POPE:4 -u CDL1:1 -u POPC:5 -l POPE:3 -l CDL1:3 -l POPC:3 -l PAPI:1 -d 10 -o system.gro -p topol.top -f ${cg_pdb} -center -pbc hex -sol W -salt 0 -excl -1
