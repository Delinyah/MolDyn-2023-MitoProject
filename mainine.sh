...
~/Project/OMM/insane -u POPE:4 -u CDL1:1 -u POPC:5 -l POPE:3 -l CDL1:3 -l POPC:3 -l PAPI:1 -d 10 -o system.gro -f ${cg_pdb} -center -pbc hex -sol W -salt 0 -excl -1 2>&1 | tee -a topol.top
