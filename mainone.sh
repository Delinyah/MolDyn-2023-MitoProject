...
function help {
  ...
  echo -e "\033[38;5;208mTitle: mainone (for MArtinize-INsanify Outer-membraNE...)#!/bin/bash

# Help function 
function help {
  echo "" 
  echo -e "\033[38;5;226mAutomated Workflow for Outer Mitochondrial Membrane Simulation Modeling\033[0m"   
  echo -e "\033[38;5;208mTitle: mainone (for 'MArtinize-INsanify Outer-membraNE...'\033[0m"
